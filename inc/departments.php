...
/*
 * Register Department taxonomy for Users
 */
...
function filter_user_taxonomy_admin_page_parent_file($parent_file = '') {
    ...
    if ( !empty( $_GET[ 'taxonomy' ] ) && ($_GET[ 'taxonomy' ] == 'department') && ($pagenow == 'edit-tags.php' || $pagenow == 'term.php') ) {
                ...
                if ( !empty( $terms ) ) :
                    ...
                    <select name="department" id="department">
                        <?php foreach ( $terms as $term ) : ?>
                            <option value="<?php echo esc_attr( $term->term_id ); ?>" <?php selected( $department, $term->term_id ); ?>><?php echo $term->name; ?></option>
                        <?php endforeach; ?>
                    </select>
                    <?php
