...
class Service extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		echo '<a href="' . ( isset( $instance['service_link'] ) ? esc_url( get_permalink( $instance['service_link'] ) ) : '#' ) . '" class="btn btn-lg btn-discover">' . esc_html__( 'More', 'viderum' ) . '</a>';
		echo '</div>';
	...
	public function form( $instance ) {
		...
		$custom_image_js = get_stylesheet_directory_uri() . '/assets/js/custom-image.js';
		wp_enqueue_script( 'keitaro-custom-image', $custom_image_js, array(), filemtime( $custom_image_js ), true );
